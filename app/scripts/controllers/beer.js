  ...
  .controller('BeerCtrl', function ($scope) {
    ...
    $scope.beerList = [
      ...
      },
      {
        ...
        "Type": "Pale",
        "ABV": 3.5,
        "Description": "Pale ale packed with American hops. Intensely refreshing and satisfying, with surprising balance and body for such low abv. Named after the character in the Yorkshire folk song On Ilkla Moor Baht�at. Hast tha� been a�cooartin Mary Jane?"
      },
      {
        "Brewer": "Ilkley",
        "Name": "Ilkley Pale",
