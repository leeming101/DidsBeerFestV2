    ...
    .controller('BeerCtrl', ['$scope', function($scope) {
        ...
        $scope.beerList =  [
            ...
            },
            {
              ...
              'Name': 'Lemon Meringue Pale',
              'ABV': 5.9,
              'Type': 'Pale'
            },
            {
              'Brewery': 'Stubborn Mule',
              'Name': 'Feckin A (milkshake IPA)',
              'ABV': 5.2,
              'Type': 'IPA'
            },
            {
            ...
            },
            {
              ...
              'Name': 'Hoppy-go-Lucky (Beer of DBF 2018)',
              'ABV': 4.1,
              'Type': 'Pale'
            },
            {
            ...
            {
              'Brewery': 'Vibrant Forest',
              'Name': 'Zephyr (Raspberry and Peach)',
              'ABV': 5,
              'Type': 'Saison'
            },
            {
